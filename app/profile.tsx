...
const styles = StyleSheet.create({
  ...
  cardTitle: { fontFamily: "BalooBold", fontSize: 21, lineHeight: 28, color: "#143D66" },
  ...
  miniValue: { fontFamily: "BalooBold", fontSize: 20, color: "#143D66", marginTop: 2 },
  ...
  bronzeTitle: { fontFamily: "BalooBold", fontSize: 20, color: "#A65D31" },
  ...
  pointsValue: { fontFamily: "BalooBold", fontSize: 22, color: "#2D52D9" },
